public class TopStudents05 {
    Student05[] listStudents;
    int idx;

    public TopStudents05(int size) {
        listStudents = new Student05[size];
        idx = 0;
    }
    ...
    public void selectionSort() {
        for (int i = 0; i < idx - 1; i++) {
            ...
            Student05 temp = listStudents[minIndex];
